            ...
            {isSignIn ? (
                <form onSubmit={handleSubmit(handleFormSubmit)} className={styles.authForm} onClick={(e) => e.stopPropagation()}>
                    <div className={styles.authInfo}>
                        <div className={styles.authElement}>
                            <label className={styles.authElementLabel}>Email</label>
                            <div>
                        ...
                        <div className={styles.authElement}>
                            <label className={styles.authElementLabel}>Password</label>
                            <div>
                ...
                <form onSubmit={handleSubmit(handleFormSubmit)} className={styles.authForm} onClick={(e) => e.stopPropagation()}>
                    <div className={styles.authInfo}>
                        ...
                        <div className={styles.authElement}>
                            <label className={styles.authElementLabel}>Repeat Password</label>
                            <input
                                className={styles.authElementInput}
